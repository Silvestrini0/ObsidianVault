...
- Una utilizza il protocollo [[POP3]] e si chiama per questo PopMail. (Outlook) (ThunderBird)
- L'altra utilizza una connessione a un sito web dedicato utilizzando il protocollo [[HTTPS]] e si chiama per questo WebMail. (Gmail)
