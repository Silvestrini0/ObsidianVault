...
- Da 0 a $2^{10}$ - 1 sono riservati per applicazioni particolari che sono definite nel layer applicazione ( esempi -> 80: http, 110: POP3, 20: [[TCP]], 21: TCP e FTP, 53: [[UDP]] e DNS, 443: TCP e https).
